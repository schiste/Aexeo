...
the 0.8.12 plugin against their Cloudflare Pages preview
deployment. 0.8.12 was already on npm before these landed; this
release bundles the fixes into one consumer-visible bump.
