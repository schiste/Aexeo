...
The manifest contract is documented in [docs/schemas/aexeo-truth.schema.json](/Users/christophehenner/Downloads/Repositories/Aexeo/docs/schemas/aexeo-truth.schema.json).
